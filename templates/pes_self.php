            ...
            <script>
                $(function() {
                  ...
                  <h4>(SELF as RATER) 25%</h4>
                  
                 
                  <form action="pes_self.php" method="POST">
                    <div class="row">
                      <div class="col">
                        ...
                        <div class="col">
                          <table class="table table-bordered">
                            ...
                            <tbody>
                              <tr>
                                <td>1</td>
                                <td>I upgrade my knowledge in my field of specialization</td>
                                <td>
                              ...
                              <tr>
                                <td>2</td>
                                <td>I contribute new innovative ideas for the development of instruction, research and extension</td>
                                <td>
                                  <div class="form-check">
                              ...
                              <tr>
                                <td>3</td>
                                <td>I expose myself to new trends in other fields</td>
                                <td>
                                  <div class="form-check">
                              ...
                              <tr>
                                <td>4</td>
                                <td>I stimulate intellectual discussion with colleagues</td>
                                <td>
                                  <div class="form-check">
                              ...
                              <tr>
                                <td>5</td>
                                <td>I perform competently assigned scholarly tasks</td>
                                <td>
                                  <div class="form-check">
                              ...
                              <tr>
                                <td>6</td>
                                <td>I keep abreast with issues/concerns of local/national and international significance</td>
                                <td>
                                  <div class="form-check">
                              ...
                              <tr>
                                <td>7</td>
                                <td>I exhibit evidence of professional and cultural growth</td>
                                <td>
                                  <div class="form-check">
                              ...
                              <tr>
                                <td>8</td>
                                <td>I possess a good command of the medium of instruction</td>
                                <td>
                                  <div class="form-check">
                              ...
                              <tr>
                                <td>9</td>
                                <td>I demontrate intellectual honesty</td>
                                <td>
                                  <div class="form-check">
                          ...
                          <div class="col">
                            <table class="table table-bordered">
                              ...
                              <tbody>
                                <tr>
                                  <td>1</td>
                                  <td>I maintain effective relationship with colleagues.</td>
                                  <td>
                                    <div class="form-check">
                                ...
                                <tr>
                                  <td>2</td>
                                  <td>I welcome suggestions from colleagues.</td>
                                  <td>
                                    <div class="form-check">
                                ...
                                <tr>
                                  <td>3</td>
                                  <td>I respect rights of others</td>
                                  <td>
                                    <div class="form-check">
                                ...
                                <tr>
                                  <td>4</td>
                                  <td>I behave within the bounds of accepted norms.</td>
                                  <td>
                                    <div class="form-check">
                                ...
                                <tr>
                                  <td>5</td>
                                  <td>I handle work related pressures pleasantly with grace.</td>
                                  <td>
                                    <div class="form-check">
                                ...
                                <tr>
                                  <td>6</td>
                                  <td>I demonstrate leadership qualities</td>
                                  <td>
                                    <div class="form-check">
                            ...
                            <div class="col">
                              <table class="table table-bordered">
                                ...
                                <tbody>
                                  <tr>
                                    <td>1</td>
                                    <td>I exhude enthusiasm in my job</td>
                                    <td>
                                      <div class="form-check">
                                  ...
                                  <tr>
                                    <td>2</td>
                                    <td>I devote official time in the accomplishment of my official functions and research.</td>
                                    <td>
                                      <div class="form-check">
                                  ...
                                  <tr>
                                    <td>3</td>
                                    <td>I observe administrative protocol</td>
                                    <td>
                                      <div class="form-check">
                                  ...
                                  <tr>
                                    <td>4</td>
                                    <td>I uphold the ideals of the institution.</td>
                                    <td>
                                      <div class="form-check">
